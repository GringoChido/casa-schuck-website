...
export async function generateMetadata({
  ...
  const description = locale === 'es'
    ? '10 suites únicas en Casa Schuck, San Miguel de Allende. Habitaciones coloniales con desayuno gourmet incluido. Reserve directo.'
    : '10 unique suites at Casa Schuck, San Miguel de Allende. Colonial rooms with gourmet breakfast included. Book direct for best rate.';
  return {
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: locale === 'es'
            ? 'Casa Schuck tiene 10 suites únicas, cada una con nombre y diseño propio.'
            : 'Casa Schuck has 10 uniquely appointed suites, each named and designed with its own character.',
        },
      },
      {
        '@type': 'Question',
