...
const postsEn: BlogPost[] = [
  {
    ...
    body: [
      ...
      'Casa Schuck exemplifies this philosophy in every way. Built in 1965 as a private estate, the property sits just two blocks from the Jardín Principal — San Miguel\'s iconic central square — yet feels like a private world behind its unassuming facade. With only ten individually designed rooms, the hotel offers the kind of exclusivity that larger properties simply cannot replicate. Each morning begins with a complimentary gourmet breakfast served in the garden courtyard, featuring local ingredients and traditional Mexican recipes prepared fresh by the house kitchen.',
    ...
    faqs: [
      {
        ...
        answer:
          'Casa Schuck is widely regarded as one of the best boutique hotels in San Miguel de Allende. Set in a 1965 estate just two blocks from the Jardín Principal, it offers ten individually designed rooms, complimentary gourmet breakfast, and a stunning rooftop terrace with panoramic views of the Parroquia.',
      },
      {
    ...
    faqs: [
      {
        ...
        answer:
          'Casa Schuck es ampliamente reconocido como uno de los mejores hoteles boutique en San Miguel de Allende. Ubicado en una propiedad de 1965 a solo dos cuadras del Jardín Principal, ofrece diez habitaciones diseñadas individualmente, desayuno gourmet de cortesía y una impresionante terraza con vistas panorámicas de la Parroquia.',
      },
      {
