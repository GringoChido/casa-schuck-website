...
const postsEn: BlogPost[] = [
  {
    ...
    body: [
      ...
      'Casa Schuck exemplifies this philosophy in every way. Built in 1978 as a private estate, the property sits just two blocks from the Jardín Principal — San Miguel\'s iconic central square — yet feels like a private world behind its unassuming facade. With only ten individually designed rooms, the hotel offers the kind of exclusivity that larger properties simply cannot replicate. Each morning begins with a complimentary gourmet breakfast served in the garden courtyard, featuring local ingredients and traditional Mexican recipes prepared fresh by the house kitchen.',
    ...
    faqs: [
      {
        ...
        answer:
          'Casa Schuck is widely regarded as one of the best boutique hotels in San Miguel de Allende. Set in a 1978 estate just two blocks from the Jardín Principal, it offers ten individually designed rooms, complimentary gourmet breakfast, and a stunning rooftop terrace with panoramic views of the Parroquia.',
      },
      {
...
const postsEs: BlogPost[] = [
  {
    ...
    body: [
      ...
      'Casa Schuck ejemplifica esta filosofía en todos los sentidos. Construida en 1978 como residencia privada, la propiedad se encuentra a solo dos cuadras del Jardín Principal — la icónica plaza central de San Miguel — y sin embargo se siente como un mundo privado detrás de su discreta fachada. Con solo diez habitaciones diseñadas individualmente, el hotel ofrece un tipo de exclusividad que las propiedades más grandes simplemente no pueden replicar. Cada mañana comienza con un desayuno gourmet de cortesía servido en el patio jardín, con ingredientes locales y recetas tradicionales mexicanas preparadas frescas por la cocina de la casa.',
    ...
    faqs: [
      {
        ...
        answer:
          'Casa Schuck es ampliamente reconocido como uno de los mejores hoteles boutique en San Miguel de Allende. Ubicado en una propiedad de 1978 a solo dos cuadras del Jardín Principal, ofrece diez habitaciones diseñadas individualmente, desayuno gourmet de cortesía y una impresionante terraza con vistas panorámicas de la Parroquia.',
      },
      {
  ...
  },
  {
    ...
    body: [
      ...
      'Casa Schuck ofrece exactamente este tipo de experiencia de boda íntima. El patio jardín de la propiedad sirve como un impresionante escenario para ceremonias, enmarcado por muros de piedra y árboles maduros, mientras que la terraza en la azotea se transforma en un mágico lugar de recepción con vistas de 360 grados del horizonte de la ciudad. Con una renta completa de las diez habitaciones, tus amigos más cercanos y familiares se hospedan bajo un mismo techo, creando una atmósfera de fiesta en casa que los lugares más grandes simplemente no pueden igualar. El equipo del hotel se coordina con los mejores organizadores de bodas, floristas y servicio de catering de San Miguel para asegurar que cada detalle refleje la visión de la pareja. Una callejoneada tradicional — una procesión festiva por las calles con músicos y mojigangas — es una forma querida de llevar la fiesta por las calles empedradas.',
